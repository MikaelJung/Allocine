	...
	<section>
		<div id="login-body">
			...
			<?php if(isset($_GET['error'])){
				...
				echo'<div class="alert success">Vous êtes désormais inscrit. <a href="profil.php">Connectez-vous</a>.</div>';
			...
			<p class="grey">Déjà sur Netflix ? <a href="profil.php">Connectez-vous</a>.</p>
		</div>
	</section>
